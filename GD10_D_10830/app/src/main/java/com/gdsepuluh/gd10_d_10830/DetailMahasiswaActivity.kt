...
import com.gdsepuluh.gd10_d_10830.databinding.ActivityDetailMahasiswaBinding
...
class DetailMahasiswaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnHapus.setOnClickListener { nim?.let { it1 -> deleteData(it1) }
        }
    ...
    fun getDataDetail(nim:String){ RClient.instances.getData(nim).enqueue(object :

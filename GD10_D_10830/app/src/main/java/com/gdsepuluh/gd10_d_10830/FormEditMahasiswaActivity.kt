...
import com.gdsepuluh.gd10_d_10830.databinding.ActivityFormEditMahasiswaBinding
...
class FormEditMahasiswaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tvEditTgl.setOnClickListener {
            val datePicker = DatePickerDialog.OnDateSetListener{ view, year, month, dayofMonth -> binding.tglEditView.text =
